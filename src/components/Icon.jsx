...
const paths = {
  ...
  cloud: 'M7 18a4 4 0 0 1-.5-7.97A5 5 0 0 1 16 8.05 4.5 4.5 0 0 1 17.5 18H7Z',
  cloudRain: 'M7 15a4 4 0 0 1-.5-7.97A5 5 0 0 1 16 5.05 4.5 4.5 0 0 1 17.5 15H7Z M8 19l-1 2M12 19l-1 2M16 19l-1 2',
  bolt: 'M13 2 4 14h6l-1 8 9-12h-6l1-8Z',
  snow: 'M12 2v20M5 6l14 12M19 6 5 18',
  fog: 'M5 8h14M3 12h18M6 16h12',
  plug: 'M9 2v4M15 2v4M7 6h10v5a5 5 0 0 1-10 0V6ZM12 16v6',
  ...
  paw: 'M8 13a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm8 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM6 8a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm12 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM12 21c-3 0-5-2-5-4.5S9 13 12 13s5 1 5 3.5S15 21 12 21Z',
  globe: 'M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0c2.5 0 4-4 4-9s-1.5-9-4-9-4 4-4 9 1.5 9 4 9Zm-9-9h18',
  x: 'M5 5l14 14M19 5 5 19',
  syringe: 'M18 2l4 4M11 9 4 16l-2 4 4-2 7-7M9 7l8 8M14 5l5 5M8.5 12.5l3 3',
}
